...
export const NewsCard: React.FC<NewsCardProps> = ({ article }) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
            {article.urlToImage && (
            ...
            <div className="p-4 flex flex-col flex-grow">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300 mt-2 flex-grow">{article.description}</p>
